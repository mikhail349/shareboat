...
window.open(a,"addTerm")}),$("#addressMapModalSearchButton").on("click",function(a){const c=$("#addressMapModalSearchText").val();return c?void b(c):void showErrorToast("\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0430\u0434\u0440\u0435\u0441")}),$("#addressMapModalSearchText").on("keydown",function(a){13==a.keyCode&&a.preventDefault()}),$("#addressMapModalSearchText").on("keyup",function(a){//alert('keyup' + e.keyCode);
if(13==a.keyCode){a.preventDefault();const b=$("#addressMapModalSearchButton");b.focus(),b.click()}}),window.isCustomLocation){var i={lat:window.boatCoordinates.lat,lng:window.boatCoordinates.lon};a(i),$(".addressLabel").text(window.boatCoordinates.address),$(".addressLabel").addClass("text-primary"),$("#switchCustomLocation").trigger("click")}});