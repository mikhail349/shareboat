...
from boat.utils import _calc_booking, calc_booking
...
class UtilsTestCase(TestCase):
    ...
    def test__calc_booking(self):
        ...
        res = _calc_booking(self.boat.pk, start_date=datetime.date(now.year, 1, 5), end_date=datetime.date(now.year, 1, 8)) 
