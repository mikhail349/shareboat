function CreateUpdate(){async function a(a){let b=[...f];const c=await axios.get(`/file/api/get_assetfiles/${a}/`);for(let d of c.data.data){let a=await fetch(d.url),c=await a.blob();c.filename=d.filename,b.push({blob:c,url:URL.createObjectURL(c)})}g(b)}async function b(a){const b=new FormData;b.append("name",h.name);for(let c of f)console.log(c.blob.filename),b.append("file",c.blob,c.blob.filename);const c=await axios.post(a,b);window.location.href=c.data.redirect}function c(a){let b=[...f];for(let c in b)if(c==a)return b.splice(c,1),void g(b)}const[d,e]=React.useState(),[f,g]=React.useState([]),[h,i]=React.useState(),[j,k]=React.useState(!0),l=React.createRef();return React.useEffect(()=>{axios.defaults.xsrfCookieName="csrftoken",axios.defaults.xsrfHeaderName="X-CSRFToken";const b=window.asset?1:0;return i(window.asset),e(b),1==b&&a(window.asset.id),()=>{for(let a of f)URL.revokeObjectURL(a.url)}},[]),/*#__PURE__*/React.createElement(React.Fragment,null,/*#__PURE__*/React.createElement("form",{onSubmit:function(a){a.preventDefault(),k(!1),0==d?b("/asset/api/create/"):b(`/asset/api/update/${h.id}/`)}},/*#__PURE__*/React.createElement("div",{className:"form-group"},/*#__PURE__*/React.createElement("label",{for:"name"},"\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u0430\u043A\u0442\u0438\u0432\u0430"),/*#__PURE__*/React.createElement("input",{type:"text",id:"name",name:"name",className:"form-control",placeholder:"\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u0430\u043A\u0442\u0438\u0432\u0430",autocomplete:"autocomplete_off_randString",required:!0,value:h&&h.name,onChange:function(a){i(b=>{const c={...b,name:a.target.value};return c})}})),/*#__PURE__*/React.createElement("div",{class:"form-group"},/*#__PURE__*/React.createElement("h4",{class:"mb-3"},"\u0424\u043E\u0442\u043E\u0433\u0440\u0430\u0444\u0438\u0438"),/*#__PURE__*/React.createElement("div",{className:`row ${f.length?"mb-3":""}`},/*#__PURE__*/React.createElement("input",{ref:l,type:"file",name:"hidden_files",accept:"image/*",multiple:!0,hidden:!0,onChange:function(a){const b=[...f];for(let c of a.target.files)/*if (!file.type.startsWith('image/')) {
                continue;
