...
$.ajax({type:"POST",url:`/boats/api/switch_fav/${a}/`,success:a=>{"redirect"===a?.data?window.location.href=a?.url:"added"===a?.data?$(b).html(`
        ...
        `)}}),$(this).removeClass("scale-anim"),$(this)[0].offsetWidth,$(this).addClass("scale-anim")})});