...
getNewMessages(){var a=this;$.ajax({type:"GET",url:this.longPollingApi}).done(function(b){if(0<b?.data?.length){for(let c of b.data)a.appendMessage(c);a.isOnBottom&&$("html, body").animate({scrollTop:$(document).height()})}getNewMessages()}).fail(function(b){0==b.status&&a.getNewMessages()})}}