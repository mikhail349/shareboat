var isOnBottom=!1;$(document).ready(()=>{function a(a){return a?.sender?.avatar?`
                <img
                    ...
                    alt 
                />
            `:"<div style=\"width:32px; height:32px\"></div>"}function b(a){const b=a.getDate(),c=a.getMonth()+1;return`${(9<b?"":"0")+b}.${(9<c?"":"0")+c}.${a.getFullYear()}, ${a.getHours()}:${a.getMinutes()}`}function c(c){const d=c.is_out?"list-group-item-primary ":"list-group-item-secondary ";return`
            <div id="msg${c.id}" class="list-group-item ${d} mb-3 rounded border pb-0" style="width: fit-content;">
